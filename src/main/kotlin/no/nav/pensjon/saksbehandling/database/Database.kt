...
internal class Database(private val dataSource: DataSource) {
    private companion object {
        private const val COUNT_AVVIKSINFORMASJON_PSAK =
            "SELECT COUNT(1) FROM PEN.T_AVVIKSINFORMASJON WHERE APPLIKASJON = 'PSAK'"
    ...
    internal fun countAvviksinformasjonFromPsak() = countQuery(COUNT_AVVIKSINFORMASJON_PSAK)

    internal fun countAvvikstilfellerFromPsak() = countQuery(COUNT_AVVIKSTILFELLER_PSAK)

    private fun countQuery(query: String): Double = try {
